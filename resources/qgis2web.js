...
map.getView().fit([80.121224, 12.881486, 80.339479, 12.991844], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!mapcredits) {
        ...
        dataAttribution.innerHTML = '<a href="https://careearthtrust.org/">Marsh data by Care Earth Trust;</a>';
